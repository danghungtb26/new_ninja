...
public class Body {
    ...
    public byte typepk;
    public short ppoint;
    public long potential0;
    public long potential1;
    public long potential2;
    public long potential3;
    public short spoint;
...
public long getMaxHP() {
    ...
    public synchronized void upHP(long hpup) {
        if (this.isDie) {
            return;
        }
        this.hp += hpup;
   ...
   public float getMaxMP() {
        float mpmax = (long) (this.getPotential(3) * 10);
     ...
     public synchronized void upMP(float mpup) {
        if (this.isDie) {
            return;
        }
        this.mp += mpup;
        if (this.mp > this.getMaxMP()) {
            this.mp = (long) this.getMaxMP();
        } else if (this.mp < 0) {
            this.mp = 0;
        }
    }
    ...
    public long dameSide() {
        long percent = this.getPramSkill(11) + this.getPramItem(94);
...
public float dameDown() {
    ...
    public long DefendNoi(){
        long dfn= 0;
        dfn += this.getPramItem(133);
        return dfn;
    }
    
    public long DefendNgoai(){
        long dfng= 0;
    ...
    public long getPotential(int i) {
        long potential = 0;
        switch (i) {
            case 0: {
    ...
    public long getPramItem(int id) {
        try {
            if (this.c.get() == null) {
                return 0;
            }
    ...
    public long getIdSkill90() {
        Skill ski;
        for(long i2 = 67; i2 <= 72; ++i2) {
            ski = this.getSkill((int) i2);
            if(ski != null) {
                return i2;
            }
        }
    ...
    public long getPramSkill(int id) {
        try {
            if (this.c.get() == null) {
                return 0;
            }
    ...
    public long getPramSkillClone(int id) {
        try {
