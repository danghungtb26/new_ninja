...
public class Char extends Body {
    ...
    public long dame = 0;
    public long tiemnang = 0;
    public int typemenu;
    public int vip;
    public int sachadmin;
    ...
    public int lvttd = 0;
    public long expkm = 0L;
    public int lvkm = 0;
    public long exphl = 0L;
    public int lvhc = 0;
    public int lvnhc = 0;
    public int lvph = 0;
    ...
    public void setXPLoadSkill(long exp) {
        ...
        try {
            ...
            m.writer().writeInt((int) this.get().getMaxHP());
            m.writer().writeInt((int) this.get().getMaxMP());
        ...
        try {
            synchronized (Server.LOCK_MYSQL) {
                ...
                if (red != null && red.first()) {
                    ...
                    nja.ppoint = (short) red.getLong("ppoint");
                    nja.potential0 = red.getLong("potential0");
                    nja.potential1 = red.getLong("potential1");
                    nja.potential2 = red.getLong("potential2");
