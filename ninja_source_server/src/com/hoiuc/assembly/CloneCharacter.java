...
public class CloneCharacter extends Body {
    ...
    public void setXPLoadSkill(long exp) {
        ...
        try {
            ...
            m.writer().writeInt((int) this.getMaxHP());
            m.writer().writeInt((int)this.getMaxMP());
            m.writer().writeLong(this.exp);
            m.writer().writeShort(this.spoint);
            m.writer().writeShort(this.ppoint);
            m.writer().writeShort((int)this.potential0);
            m.writer().writeShort((int)this.potential1);
            m.writer().writeInt((int)this.potential2);
            m.writer().writeInt((int)this.potential3);
            m.writer().flush();
