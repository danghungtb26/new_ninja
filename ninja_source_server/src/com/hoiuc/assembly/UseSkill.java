...
public class UseSkill {
    ...
    private static void useSkillBuff(Player p, int skilltemp) {
        ...
        switch (skilltemp) {
            case 6: {
                p.setEffect(15, 0, (int) (p.c.get().getPramSkill(53) * 1000), 0);
                break;
            }
            case 13: {
                p.setEffect(9, 0, 30000, (int) p.c.get().getPramSkill(51));
                break;
            }
            case 15: {
                p.setEffect(16, 0, 5000, (int) p.c.get().getPramSkill(52));
                break;
            }
            //Gốc cây
            case 22: {
                long per = Util.nextInt(0,1);
                BuNhin buNhin = new BuNhin(p.c.name,(short)(per==1?p.c.x+30:p.c.x-30),p.c.y, (long) (System.currentTimeMillis()+p.c.getPramSkill(49)*1000), p.c.id,(int) p.c.get().getMaxHP(),(int) p.c.get().Miss());
                if(p.c.tileMap != null) {
            ...
            case 31: {
                p.setEffect(10, 0, 90000, (int) p.c.get().getPramSkill(30));
                break;
            }
            case 33: {
                p.setEffect(17, 0, 5000, (int) p.c.get().getPramSkill(56));
                break;
            }
            case 47: {
            ...
            case 58: {
                p.setEffect(11, 0, (int) p.c.get().getPramSkill(64), 20000);
                break;
            }
            case 67:
            case 68:
            ...
            case 72: {
                ...
                p.c.clone.islive = true;
                p.c.clone = CloneCharacter.getClone(p.c);
                p.c.clone.open((long) (System.currentTimeMillis() + 60000 * p.c.getPramSkill(68)), (int) p.c.getPramSkill(71));
    ...
    public static void useSkillCloneBuff(Body body, int skilltemp) {
        ...
        if(skill != null) {
            ...
            if(skill.coolDown <= System.currentTimeMillis()) {
                ...
                switch (skilltemp) {
                    case 51:
                        param = (int) body.getPramSkillClone(45);
                        param += body.getPramSkillClone(66);
                        p.setEffect(19, 0, 90000, param);
                        break;
                    case 52:
                        param = (int) (body.getPramSkillClone(40)*1000);
    ...
    public static void buffLive(Player p, Message m) {
        try {
            ...
            if (nj != null && nj.get().isDie && nj.mapid != 133 && nj.mapid != 111) {
                ...
                skill.coolDown = System.currentTimeMillis() + temp.coolDown;
                nj.p.liveFromDead();
                nj.p.setEffect(11, 0, 5000, (int) p.c.get().getPramSkill(28));
            }
        } catch (Exception e) {
