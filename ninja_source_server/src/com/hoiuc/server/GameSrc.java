    ...
    private static void handlenangbikip(Player p, Item item, int type) {
        try {
            ...
            if (Util.nextInt(150) < upPer) {
                ...
                Option op = new Option(57, 1000);
                itemup.options.add(op);
                op = new Option(58, 5 * itemup.upgrade);
                itemup.options.add(op);
