...
public class Manager {
    ...
    public Manager() {
        ...
        this.OptionsTuTien = new String[]{"Ở tầng này cơ thể con chưa được tăng cái gì hết tu luyện thêm đi",// tầng 0
                                            ...
                                            Title + TAN_CONG_QUAI + "20000\n" + TANG_HP + "20000\n" + TAN_CONG + "10000", // tầng 2
                                            Title + TAN_CONG_QUAI + "30000\n" + TANG_HP + "30000\n" + TAN_CONG + "15000", // tầng 3
                                            Title + TAN_CONG_QUAI + "40000\n" + TANG_HP + "40000\n" + TAN_CONG + "20000", //tầng 4
                                            Title + TAN_CONG_QUAI + "50000\n" + TANG_HP + "50000\n" + TAN_CONG + "25000",// tầng 5
                                            Title + TAN_CONG_QUAI + "60000\n" + TANG_HP + "60000\n" + TAN_CONG + "30000\n" + GIAM_SAT_THUONG + "6000",// tầng 6
                                            Title + TAN_CONG_QUAI + "70000\n" + TANG_HP + "70000\n" + TAN_CONG + "35000\n" + GIAM_SAT_THUONG + "7000",// tầng 7
                                            Title + TAN_CONG_QUAI + "80000\n" + TANG_HP + "80000\n" + TAN_CONG + "40000\n" + GIAM_SAT_THUONG + "8000",// tầng 8
                                            Title + TAN_CONG_QUAI + "90000\n" + TANG_HP + "90000\n" + TAN_CONG + "45000\n" + GIAM_SAT_THUONG + "9000",// tầng 9
                                            Title + TAN_CONG_QUAI + "100000\n" + TANG_HP + "100000\n" + TAN_CONG + "50000\n" + GIAM_SAT_THUONG + "10000\n",// tầng 10
                                            Title + TAN_CONG_QUAI + "110000\n" + TANG_HP + "110000\n" + TAN_CONG + "55000\n" + GIAM_SAT_THUONG + "11000\n" + X2_CHI_MANG + "11%",// tầng 11
                                            Title + TAN_CONG_QUAI + "120000\n" + TANG_HP + "120000\n" + TAN_CONG + "60000\n" + GIAM_SAT_THUONG + "12000\n" + X2_CHI_MANG + "12%",// tầng 12
                                            Title + TAN_CONG_QUAI + "130000\n" + TANG_HP + "130000\n" + TAN_CONG + "65000\n" + GIAM_SAT_THUONG + "13000\n" + X2_CHI_MANG + "13%",// tầng 13
                                            Title + TAN_CONG_QUAI + "140000\n" + TANG_HP + "140000\n" + TAN_CONG + "70000\n" + GIAM_SAT_THUONG + "14000\n" + X2_CHI_MANG + "14%",// tầng 14
                                            Title + TAN_CONG_QUAI + "150000\n" + TANG_HP + "150000\n" + TAN_CONG + "75000\n" + GIAM_SAT_THUONG + "15000\n" + X2_CHI_MANG + "15%",// tầng 15
                                            Title + TAN_CONG_QUAI + "160000\n" + TANG_HP + "160000\n" + TAN_CONG + "80000\n" + GIAM_SAT_THUONG + "16000\n" + X2_CHI_MANG + "16%\n" + HUT_MAU + "5%\n" + HUT_MAU_QUAI + "5% tấn công\n" + HUT_MAU_NGUOI + "1% tấn công",// tầng 16
                                            Title + TAN_CONG_QUAI + "170000\n" + TANG_HP + "17000\n" + TAN_CONG + "85000\n" + GIAM_SAT_THUONG + "17000\n" + X2_CHI_MANG + "17%n" + HUT_MAU + "6%\n" + HUT_MAU_QUAI + "6% tấn công\n" + HUT_MAU_NGUOI + "2% tấn công",// tầng 17
                                            Title + TAN_CONG_QUAI + "180000\n" + TANG_HP + "180000\n" + TAN_CONG + "90000\n" + GIAM_SAT_THUONG + "18000\n" + X2_CHI_MANG + "18%\n" + HUT_MAU + "7%\n" + HUT_MAU_QUAI + "7% tấn công\n" + HUT_MAU_NGUOI + "3% tấn công",// tầng 18
                                            Title + TAN_CONG_QUAI + "190000\n" + TANG_HP + "190000\n" + TAN_CONG + "95000\n" + GIAM_SAT_THUONG + "19000\n" + X2_CHI_MANG + "19%n" + HUT_MAU + "8%\n" + HUT_MAU_QUAI + "8% tấn công\n" + HUT_MAU_NGUOI + "4% tấn công",// tầng 19
                                            Title + TAN_CONG_QUAI + "200000\n" + TANG_HP + "200000\n" + TAN_CONG + "10000\n0" + GIAM_SAT_THUONG + "20000\n" + X2_CHI_MANG + "20%\n" + HUT_MAU + "9%\n" + HUT_MAU_QUAI + "9% tấn công\n" + HUT_MAU_NGUOI + "5% tấn công",// tầng 20
                                            Title + TAN_CONG_QUAI + "210000\n" + TANG_HP + "210000\n" + TAN_CONG + "105000\n" + GIAM_SAT_THUONG + "2100\n" + X2_CHI_MANG + "21%\n" + HUT_MAU + "10%\n" + HUT_MAU_QUAI + "10% tấn công\n" + HUT_MAU_NGUOI + "6% tấn công",// tầng 21
                                            Title + TAN_CONG_QUAI + "220000\n" + TANG_HP + "220000\n" + TAN_CONG + "110000\n" + GIAM_SAT_THUONG + "22000\n" + X2_CHI_MANG + "22%\n" + HUT_MAU + "11%\n" + HUT_MAU_QUAI + "11% tấn công\n" + HUT_MAU_NGUOI + "7% tấn công",// tầng 22
                                            Title + TAN_CONG_QUAI + "230000\n" + TANG_HP + "230000\n" + TAN_CONG + "120000\n" + GIAM_SAT_THUONG + "23000\n" + X2_CHI_MANG + "23%\n" + HUT_MAU + "12%\n" + HUT_MAU_QUAI + "12% tấn công\n" + HUT_MAU_NGUOI + "8% tấn công",// tầng 23
        };
