...
public class Menu {
        ...
        switch (menuId) {
            case 0: {
                switch (b3) {
                    ...
                    case 1: {
                        if (p.coinnap >= 600000 && p.c.vip == 1 && p.c.vip < 2) {
                            if (p.c.getBagNull() < 10) {
                                Service.chatNPC(p, (short) npcid, Language.NOT_ENOUGH_BAG);
                                return;
                            }
                    ...
                    case 2: {
                        if (p.coinnap >= 700000 && p.c.vip == 2 && p.c.vip < 3) {
                            if (p.c.getBagNull() < 10) {
                                Service.chatNPC(p, (short) npcid, Language.NOT_ENOUGH_BAG);
                                return;
                            }
                    ...
                    case 3: {
                        if (p.coinnap >= 800000 && p.c.vip == 3 && p.c.vip < 4) {
                            if (p.c.getBagNull() < 1) {
                                Service.chatNPC(p, (short) npcid, Language.NOT_ENOUGH_BAG);
                                return;
                            }
                    ...
                    case 5: {
                        ...
                        if (p.coinnap >= 1000000 && p.c.vip == 5 && p.c.vip < 6) {
                            if (p.c.getBagNull() < 1) {
                                Service.chatNPC(p, (short) npcid, Language.NOT_ENOUGH_BAG);
                                return;
                            }
                    ...
                    case 6: {
                        if (p.coinnap >= 1200000 && p.c.vip == 6 && p.c.vip < 7) {
                            if (p.c.getBagNull() < 1) {
                                Service.chatNPC(p, (short) npcid, Language.NOT_ENOUGH_BAG);
                                return;
                            }
    ...
    public static void npcMiNuong(Player p, byte npcid, byte menuId, byte b3) throws IOException, InterruptedException {
        switch (menuId) {
            case 0: {
                if (p.c.isNhanban) {
                    p.conn.sendMessageLog("Chức năng này không dành cho phân thân");
                ...
                if (p.c.quantityItemyTotal(1003) < 2) {
                    p.conn.sendMessageLog("bạn cần có đủ 2 viên Đá Ngũ Sắc");
                    return;
                }
                if (p.c.level < 150) {
                    Service.chatNPC(p, (short) npcid, "yêu cầu lv150");
                    ...
                    if (tinhfox > 50) {
                        ...
                        Server.manager.chatKTG("Người chơi " + p.c.name + " Chuyển Sinh Thất Bại,đen lắm bạn ơi!");
                    } else {
    ...
    public static void npcquylao(Player p, byte npcid, byte menuId, byte b3) throws IOException {
        switch (menuId) {
            ...
            case 0: {
                Service.sendInputDialog(p, (short) 24, "Tỷ lệ đổi 1 lượng = 1 xu");

                break;
            }
            case 1: {
                Service.sendInputDialog(p, (short) 25, "Tỷ lệ đổi 1 lượng = 1 yên");

                break;
            }
            case 2: {
                if (p.c.xu < 500000) {
                    Service.chatNPC(p, (short) npcid, "Cần 500k xu");
                    break;
                    ...
                    case 0: {
                        ...
                        if (p.c.quantityItemyTotal(944) < 1) {
                            ...
                            if (percent >= 0 && percent < 33) {
                                p.conn.sendMessageLog("Npc ra kéo. Bạn thua 1 lon bia 333");
        ...
        switch (menuId) {
            case 0: {
                switch (b3) {
                    ...
                    case 0: {
                        if (p.c.level < 150) {
                            Service.chatNPC(p, (short) npcid, "con nít đi chỗ khác chơi.");
                            return;
                        }
