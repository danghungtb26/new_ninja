...
public class Service {
    ...
    public static void sendInfoChar(Player player, Player _p) {
        ...
        try {
            ...
            m.writer().writeInt((int) player.c.get().hp);
            m.writer().writeInt((int) player.c.get().getMaxHP());
            ...
            m.writer().writeShort((int) player.c.get().eff5buffHP());
            m.writer().writeShort((int) player.c.get().eff5buffMP());
    ...
    public static void sendclonechar(Player p, Player top) {
        try {
            ...
            m.writer().writeInt((int) p.c.clone.hp);
            m.writer().writeInt((int) p.c.clone.getMaxHP());
            ...
            m.writer().writeShort((int) p.c.eff5buffHP());
            m.writer().writeShort((int) p.c.eff5buffMP());
            m.writer().writeByte(0);
    ...
    public static void CharViewInfo(Player p, boolean sendEff) {
        ...
        try {
            ...
            msg.writer().writeByte((int) c.get().speed());
            msg.writer().writeUTF(c.name);
            msg.writer().writeByte(c.get().pk);
            msg.writer().writeByte(c.get().typepk);
            msg.writer().writeInt((int) c.get().getMaxHP());
            msg.writer().writeInt((int) c.get().hp);
            msg.writer().writeInt((int) c.get().getMaxMP());
            msg.writer().writeInt((int) c.get().mp);
            msg.writer().writeLong(c.get().exp);
            msg.writer().writeLong(c.get().expdown);
            msg.writer().writeShort((int) c.get().eff5buffHP());
            msg.writer().writeShort((int) c.get().eff5buffMP());
            msg.writer().writeByte(c.get().nclass);
            msg.writer().writeShort(c.get().ppoint);
            msg.writer().writeShort((int) c.get().potential0);
            msg.writer().writeShort((int) c.get().potential1);
            msg.writer().writeInt((int) c.get().potential2);
            msg.writer().writeInt((int) c.get().potential3);
    ...
    public static void sendInfoPlayers(Player player, Player p) {
        ...
        try {
            ...
            m.writer().writeInt((int) p.c.get().mp);
            m.writer().writeInt((int) p.c.get().getMaxMP());
            m.writer().writeByte((int) p.c.get().speed());
            m.writer().writeShort((int) p.c.get().ResFire());
            m.writer().writeShort((int) p.c.get().ResIce());
            m.writer().writeShort((int) p.c.get().ResWind());
            m.writer().writeInt((int) p.c.get().dameMax());
            m.writer().writeInt((int) p.c.get().dameDown());
            m.writer().writeShort((int) p.c.get().Exactly());
            m.writer().writeShort((int) p.c.get().Miss());
            m.writer().writeShort((int) p.c.get().Fatal());
            m.writer().writeShort((int) p.c.get().ReactDame());
            m.writer().writeShort((int) p.c.get().sysUp());
            m.writer().writeShort((int) p.c.get().sysDown());
