          ...
          /*       if (sec %5 == 0) {
                ...
                if (sec %5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Nso bia 444, có không giữ mất đừng thì thôi "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
                ...
                if (sec %5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Nso bia 444, có không giữ mất thì thôi "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Nso bia 444 "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
