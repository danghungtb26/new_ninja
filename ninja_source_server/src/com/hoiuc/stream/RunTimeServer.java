            ...
            while (Server.running) {
                ...
                synchronized (ThienDiaBangManager.thienDiaBangManager) {
                    if (ThienDiaBangManager.thienDiaBangManager[0] != null) {
                        if (!Util.isSameWeek(Date.from(Instant.now()),
                                Util.getDate2(ThienDiaBangManager.thienDiaBangManager[0].getWeek()))) {
                ...
                if ((sec % 1 == 0 || sec == 0)) {
                    try {
                        ...
                        // Server.manager.taixiu[0].totaltai >= 1 ) {
                        if ((Server.manager.taixiu[0]).start == true) {
                ...
                if (hour == 19 && min == 00 && sec == 0) {
                    ...
                    if (ChienTruong.chienTruong == null) {
                        Manager.serverChat("Server",
                                "Chiến trường lv30 đã mở báo danh, hãy nhanh chân đến báo danh chuẩn bị chiến đấu.");
                ...
                if (hour == 21 && min == 0 && sec == 0) {
                    ...
                    if (ChienTruong.chienTruong == null) {
                        Manager.serverChat("Server",
                                "Chiến trường lv50 đã mở báo danh, hãy nhanh chân đến báo danh chuẩn bị chiến đấu.");
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Chào anh em tên là Bulma... Năm nay em vừa tròn 18..."); // thay nội dung
                                                                                                      // chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Có không giữ mất đừng thì thôi "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Có không giữ mất thì thôi "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("NSO "); // thay nội dung chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                        e.printStackTrace();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Phụ nữ giống như con đường, đường càng cong thì càng nguy hiểm."); // thay
                                                                                                                // nội
                                                                                                                // dung
                                                                                                                // chat
                        m.writer().flush();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Tiền thì em không thiếu nhưng nhiều thì em không có."); // thay nội dung
                                                                                                     // chat
                        m.writer().flush();
                        Client.gI().NinjaMessage(m);
                    } catch (Exception e) {
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Nếu đã yêu thì yêu cho tới, đừng nửa vời rồi lại vội buông lơi."); // thay
                                                                                                                // nội
                                                                                                                // dung
                                                                                                                // chat
                        m.writer().flush();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF(
                                "Khả năng thiên bẩm của những đứa thần kinh là làm cho những đứa thông minh phải ức chế."); // thay
                                                                                                                            // nội
                                                                                                                            // dung
                                                                                                                            // chat
                        m.writer().flush();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF("Tương lai khóc hay cười còn phụ thuộc vào độ lười của quá khứ."); // thay
                                                                                                               // nội
                                                                                                               // dung
                                                                                                               // chat
                        m.writer().flush();
                ...
                if (sec % 5 == 0) {
                    ...
                    try {
                        ...
                        m.writer().writeUTF(
                                " Hình như tôi chiều các em quá nên các em hư rồi phải không? Thôi, em thích là được. Em là của anh."); // thay
                                                                                                                                        // nội
                                                                                                                                        // dung
                                                                                                                                        // chat
                        m.writer().flush();
                 ...
                 * m = new Message(38);
                 * m.writer().writeShort(44);//thay id npc
                 * m.writer().writeUTF("Thử một lần chơi lớn xem có ai trầm trồ không."); //
                 * thay nội dung chat
                 * m.writer().flush();
                 * Client.gI().NinjaMessage(m);
                 * } catch (Exception e) {
