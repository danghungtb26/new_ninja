    ...
    public void sendCharInfo(Player p2) {
        if(p2 != null && p2.c != null && p2.conn != null) {
            ...
            try {
                ...
                m.writer().writeInt((int) ninjaBot.get().hp);
                m.writer().writeInt((int) ninjaBot.get().getMaxHP());
                ...
                m.writer().writeShort((int) ninjaBot.get().eff5buffHP());
                m.writer().writeShort((int) ninjaBot.get().eff5buffMP());
